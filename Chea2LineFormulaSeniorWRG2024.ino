...
void setup() {
 ...
 Serial.begin(9600);
  ...
  TurnSpeedLeft(70, 50, 50);                                                          // ค่าเลี้ยวซ้าย TurnSpeedLeft(มอเตอร์ซ้าย, มอเตอร์ขวา, เวลาเลี้ยว);
  TurnSpeedRight(50, 70, 50);                                                         // ค่าเลี้ยวขวา TurnSpeedRight(มอเตอร์ซ้าย, มอเตอร์ขวา, เวลาเลี้ยว);
...
// ShowRead_sumValue_sensor();  //แสดงหน้าจอผลรวมเซนเซอร์ที่เจอเส้น
  ...
  // TrackCross(40, 0.034, 0.34, 'r');   // PID จนกว่าจะเจอแยก TrackCross(Speed, Kp , Kd , 'คำสั่งเจอแยก'); 
    ...
    TrackSumValue(50, 0.017, 0.500, 4000, 's');                                           //TrackSumValue(speed, kp, kd, ค่าของเซนเซอร์, เงื่อนไข);
    // TrackSumValue(70, 0.065, 0.40, 7000, 'l'); 
